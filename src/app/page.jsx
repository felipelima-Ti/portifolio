...
*/}
 ...
 <div className="bg-black/40 rounded-2xl p-6 shadow-xl border border-white/20">
  ...
  <span className="border border-white text-white/70 rounded-xl px-4 py-2 text-sm">
    Python
  </span>
...
<div className="bg-gray-700/30 p-5 justify-right text-right">
    {/* Imagem à direita */}
    <img
      src="/git.png"
      alt="Discord AI Bot"
...
<div className="bg-black justify-right text-right">
    {/* Imagem à direita */}
    <img
      src="/vic.png"
      alt="port vic"
